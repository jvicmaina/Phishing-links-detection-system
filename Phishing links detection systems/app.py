 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    st.write('''My dissertation project presented on July 2022: A student. Which one do YOU write like?''')\n",
    "\n",
    "    with open('C:/Users/jvicm/Desktop/Phishing-URL-Detection-main/rfc.pkl', mode='rb') as pickle_in:\n",
